...
Check out Airbnb's most recent [instructions](https://www.npmjs.com/package/eslint-config-airbnb) to install the config package and all its dependencies correctly. As of 2021-11-24, (use "npm -v" to check the version and "npm install -g npm@latest" to upgrade(Reference: https://docs.npmjs.com/try-the-latest-stable-version-of-npm). they recommend using the following command in your terminal:
